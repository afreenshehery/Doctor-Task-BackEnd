...
let edit_patient = async (req, res, next) => {
    console.log("reached controller");
    console.log(req.body);
    return manager.edit_patient(req, req.params.id, req.HospitalId)
        .then(data => {
            let result = {
                status: 200,
                data: data
...
let treeView = async (req, res, next) => {
    console.log("reached controller");
    return manager.treeView(req.body)
        .then(data => {
            let result = {
                status: 200,
                data: data.data,
...
let getTreeView = async (req, res, next) => {
    return manager.getTreeView(req).then(data => {
        let result = {
            status: 200,
            data: data.data,
            id: data.id
...
let putTReeView = async (req, res, next) => {
    return manager.putTreeView(req, req.body).then(data => {
        let result = {
            status: 200,
            data: data.data,
            id: data.id
...
let sendRecursive = async (req, res, next) => {
    console.log("reached controller");
    return manager.sendRecursive(req.body)
        .then(data => {
            let result = {
                status: 200,
                data: data.data,
...
let getRecursive = async (req, res, next) => {
    return manager.getRecursive(req).then(data => {
        let result = {
            status: 200,
            data: data.data,
            id: data.id
...
let cuntryDerails = async (req, res, next) => {
    console.log("reached controller");
    return manager.cuntryDerails(req.body)
        .then(data => {
            let result = {
                status: 200,
                data: data.allData,
...
let getCuntry = async (req, res, next) => {
    return manager.getCuntry(req).then(data => {
        let result = {
            status: 200,
            data: data.data,
            // id: data.id
...
module.exports = { Admin_Register, getRecursive, getCuntry, cuntryDerails, sendRecursive, putTReeView, getTreeView, treeView, Admin_login, Add_Petient, Add_staff, destroy_patient, edit_patient, destroy_staff, edit_staff, get_staff, get_patient, get_staff_update, get_patient_update, getAdmin, getRegisterInfo, editAdmin }